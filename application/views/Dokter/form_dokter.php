    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card pd-20 pd-sm-30 form-layout form-layout-4">
                ...
                <form action="<?php echo site_url('Dokter/add_data') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-4 form-control-label"><span class="tx-danger">*</span>Nomer Registrasi Dokter:</label>
                        <div class="col-sm-8">
                            <input type="text" name="nomer_dokter" class="form-control" placeholder="Masukan Nomer Registrasi Dokter " required>
                        </div>
                    </div>

                    <div class="form-group row">
                            <label class="col-sm-4 form-control-label"><span class="tx-danger"></span>Nama Dokter:</label>
                            <div class="col-sm-8">
                                <input type="text" name="nama_dokter" class="form-control" placeholder="Masukan Nama Dokter " >
                            </div>
                        </div>
                        ...
                        <div class="row row-xs mg-t-20">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="spesialis" class="form-control" placeholder="Masukan Spesialis Dokter " >
                            </div>
                        </div>
                    <div class="row row-xs mg-t-20">
