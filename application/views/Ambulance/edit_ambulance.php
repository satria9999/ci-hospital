...
<div class="sl-pagebody">
            <div class="sl-page-title">
                <h5>Form Edit Ambulance</h5>
                <p>Form yang digunakan untuk edit data Ambulance.</p>
            </div><!-- sl-page-title -->
            <div class="col-xl-7 mg-t-25 mg-xl-t-0">
                <div class="card pd-20 pd-sm-30 form-layout form-layout-4">
                    <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Edit Data Ambulance</h6>
                    <p class="mg-b-30 tx-gray-600"></p>
                    <form action="<?php echo site_url('Ambulance/update/'.$row->id_ambulance)?>" method="post" enctype="multipart/form-data" >
                        <!-- Nama Lengkap -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="row row-xs mg-t-20">
                            ...
                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                <input class="form-control" type="number" value="<?php echo $row->nomor_telepon;?>" name="nomor_telepon" placeholder="Masukan Nomor Telepon">
                            </div>
                    </div>
                        <div class="row row-xs mg-t-30">
                            <div class="col-sm-8 mg-l-auto">
                                <div class="form-layout-footer">
                                    ...
                                    <a href="<?php echo base_url('Dashboard/lihat_ambulance'); ?>" type="button" class="btn btn-secondary">Cancel</a>
