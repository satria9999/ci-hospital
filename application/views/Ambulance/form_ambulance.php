...
<div class="sl-pagebody">
    <div class="sl-page-title">
        <h5>Form Ambulamce</h5>
        <p>Form yang digunakan untuk input data Ambulamce.</p>
    </div><!-- sl-page-title -->

    <div class="row">
        <div class="col-lg-8">
            <div class="card pd-20 pd-sm-30 form-layout form-layout-4">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Input Data Ambulamce</h6>
                <p class="mg-b-30 tx-gray-600"></p>

                <form action="<?php echo site_url('Ambulance/add_data') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row row-xs mg-t-20">
                            ...
                            <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                <input class="form-control" type="number" name="nomor_telepon" placeholder="Masukan Nomor Telepon">
                            </div>
                    </div>
