<head>
    ...
    <!-- Logo -->
    <link href="<?= base_url(); ?>assets/img/logo_remove.png"" rel="icon" />
    <link href="<?= base_url(); ?>assets/img/logo_remove.png rel="apple-touch-icon" />
    <!-- Meta -->
    <meta name="description" content="Premium Quality and Responsive UI for Dashboard.">
    <meta name="author" content="ThemePixels">

    <title>Green Hospital Management</title>
