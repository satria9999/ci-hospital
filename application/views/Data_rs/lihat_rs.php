...
<div class="sl-pagebody">
    <div class="sl-page-title">
        ...
        <p>Data-data Rumah Sakit</p>
        <br>
        <a href="<?php echo site_url('Dashboard/form_rs'); ?>">
  <button class="btn btn-outline-primary" style="width: 120px; ">
    <i class="fa fa-plus mg-r-10"></i> Tambah Rs
  </button></a>
                    ...
                    <tr>
                        ...
                        <td>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="<?php echo site_url('Rumah_Sakit/edit_data/'. $key->id_rumahsakit); ?>"><i class="icon ion-edit"></i> Edit</a>
                                        <button class="dropdown-item deleteButton" data-id="<?php echo $key->id_rumahsakit; ?>"> <i class="icon ion-trash-a"></i> Hapus Data</button>
                                    </div>
                                </div>
                        </td>
                    </tr>
...
<script>
    ...
    function deleteData(id_rumahsakit) {
    $.ajax({
        type: 'POST',
        url: '<?php echo site_url('Rumah_Sakit/aksi_hapus_rs/'); ?>' + id_rumahsakit,
        success: function() {
