...
<div class="sl-pagebody">
    <div class="sl-page-title">
        <h5>Form Slider Image</h5>
        <p>Form yang digunakan untuk input data Slider Image.</p>
    </div><!-- sl-page-title -->
    <div class="col-xl-7 mg-t-25 mg-xl-t-0">
        <div class="card pd-20 pd-sm-30 form-layout form-layout-4">
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Input Data Slider Image</h6>
            <p class="mg-b-30 tx-gray-600"></p>
            <form action="<?php echo site_url('Sliderimage/add_data') ?>" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
