...
<div class="sl-pagebody">
    <div class="sl-page-title">
        <h5>Data Layanan Rumah Sakit</h5>
        <p>Data-data Layanan Rumah Sakit</p>
        <br>
  ...
  <a href="<?php echo site_url('Rumah_Sakit/export_excelall'); ?>" <button class="btn btn-outline-success" style="width: 120px; ">
    ...
    <div class="card pd-20 pd-sm-40">
        <h6 class="card-body-title">Tabel Layanan Rumah Sakit</h6>
        <p class="mg-b-20 mg-sm-b-30">Data Layanan Rumah Sakit</p>
                    ...
                    <tr>
                        ...
                        <td>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="<?php echo site_url('Layanan/edit_data/'. $key->id_layanan); ?>"><i class="icon ion-edit"></i> Edit</a>
